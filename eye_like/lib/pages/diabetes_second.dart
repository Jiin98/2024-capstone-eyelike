...
class DiabetesSecond extends StatefulWidget {
  const DiabetesSecond({super.key});

  @override
  State<DiabetesSecond> createState() => _DiabetesSecondState();
}

class _DiabetesSecondState extends State<DiabetesSecond> {
